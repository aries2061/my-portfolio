...
const ExperienceItem = ({ title, company, years, bullets }) => (
...
const SkillPill = ({ skill }) => (
  <span className="bg-blue-100 text-blue-800 text-sm font-medium px-4 py-2 rounded-full border border-blue-400">
    {skill}
  </span>
);
